      ...
      const { EmbedBuilder } = require('discord.js')
        const embed = new EmbedBuilder()
          ...
          url: 'https://discord.gg/FUEHs7RCqz'
            ...
            .setDescription(`__**เกี่ยวกับฉัน**__:\n\n บอทDJ Jamesใช้โค๊ดจากRTX GAMING และมีการแปลถาษาไทยให้บอทโดยเจมส์
ทุกคนสามารถดูโครงการMusicBotได้ที่GitHub
ขอบคุณโค๊ดจากRTX-GAMINGG\n GitHub : ❤️ [RTX-GAMINGG](${githubLink1})\n GitHub : 💙 [KILLHU(James)](${githubLink2})`)
            .setTimestamp();
